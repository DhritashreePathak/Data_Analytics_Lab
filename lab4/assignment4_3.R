#Q3: Take a random sample from the normal distribution, and plot the estimated density function. Now take repeated samples of size 4, calculate the mean for each such sample, and
