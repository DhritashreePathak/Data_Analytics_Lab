...
#(b) Perform K-Means Clustering selecting the best value of k and taking Euclidean distance as similarity measure.
#Check your algorithm with the following three conditions , visulaise the clusters and note the difference

#i. Maximum number of iterations
#ii. Cluster centroid remains unchanged
#iii. Highest quality of cluster is reached.

#(c) Repeat the Q.2 taking Manhattan distance as similarity measure and note the difference between the clusters as compared to that found in Q. 2.
